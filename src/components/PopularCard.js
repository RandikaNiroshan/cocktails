...
const PopularCard = ({ cocktail }) => {
  const { id, drink, image, category, alcohol } = cocktail;
  return (
    <div className="bg-white mx-3 my-1 h-full w-auto rounded-lg drop-shadow-lg group overflow-hidden relative hover:ring-1 hover:ring-white">
      <div className="p-2 relative">
        <img
          className="aspect-[4/3] w-full object-cover rounded-[5px] group-hover:scale-[1.25] group-hover:rotate-12 group-hover:blur-[2px] basic-transition"
