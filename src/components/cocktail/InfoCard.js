  ...
  return (
    <>
      ...
      {loading === HTTP_STATUS.FULFILLED && (
        <>
          <div className="flex flex-col justify-center items-center rounded-lg border-[3px] border-dashed w-full h-auto px-8 py-2 cursor-default">
            <p className="text-[14px] font-app-text text-app-cadet text-center">
              {data}
            </p>
