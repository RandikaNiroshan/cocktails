  ...
  return (
    <section className="px-10 pt-10 py-5 sm:px-24 md:px-32 z-[2] overflow-hidden h-min">
      ...
      <div className="mt-14 grid grid-rows-3 sm:grid-cols-3 sm:grid-rows-none sm:gap-[3vw] md:gap-[5vw]">
        <StatsCard count="635" title="Total Cocktails" image={ImgDrinks} scrollTo="cocktails"/>
        <StatsCard count="58" title="Non Alcoholic" image={ImgNonAlcoholic} link="/alcoholic?id=1"/>
        <StatsCard count="488" title="Ingredients" image={ImgIngredients} link="/ingredients"/>
      </div>
    </section>
  );
};
