                ...
                {alcoholic.map((item, index) => {
                  return (
                    <Link
                      ...
                      className="text-start w-max text-[13px] font-app-main text-white md:hover:text-app-flame basic-transition cursor-pointer mb-1"
                    >
                      {item.strAlcoholic}
                    </Link>
                  );
                  ...
                  {categories.map((item, index) => {
                    return (
                      <Link
                        ...
                        className="text-center w-max text-[13px] font-app-main text-white md:hover:text-app-flame basic-transition cursor-pointer"
                      >
                        {item.strCategory}
                      </Link>
                    );
